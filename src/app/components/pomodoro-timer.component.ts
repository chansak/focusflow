...
@Component({
  ...
  template: `
    <div class="timer-container" (keydown)="onKeyDown($event)">
      <mat-card
        class="timer-card"
        [class.focus-mode]="pomodoroService.currentMode() === 'focus'"
        [class.break-mode]="pomodoroService.currentMode() === 'break'"
        role="main"
        [attr.aria-label]="
          'Pomodoro timer in ' + pomodoroService.currentMode() + ' mode'
        "
      >
        <mat-card-header>
          <mat-card-title class="timer-title">
            <mat-icon
              [attr.aria-label]="
                pomodoroService.currentMode() === 'focus'
                  ? 'Focus session'
                  : 'Break session'
              "
            >
        ...
        <mat-card-content>
          ...
          <div class="timer-display">
            <div
              class="time-text"
              [attr.aria-label]="
                'Time remaining: ' + pomodoroService.formattedTime()
              "
            >
            ...
            <mat-progress-bar
              ...
              [attr.aria-label]="
                'Progress: ' +
                Math.round(pomodoroService.progress()) +
                ' percent complete'
              "
            >
            </mat-progress-bar>
          ...
          <div class="timer-controls">
            <button
              ...
              (click)="toggleTimer()"
              [attr.aria-label]="
                pomodoroService.isRunning() ? 'Pause timer' : 'Start timer'
              "
            >
              <mat-icon>{{
          ...
          <div class="session-info">
            <div class="session-counter">
              ...
              <span
                >{{ pomodoroService.sessionsCompletedToday() }} sessions
            ...
            <div class="focus-time">
              ...
              <span
                >{{
                  formatFocusTime(pomodoroService.totalFocusTimeToday())
                }}
                focused today</span
              >
            </div>
          ...
          <div class="keyboard-help" [class.expanded]="showKeyboardHelp">
            ...
            >
              <mat-icon>{{
                showKeyboardHelp ? 'keyboard_arrow_up' : 'keyboard_arrow_down'
              }}</mat-icon>
              <span class="help-toggle-text">
                {{ showKeyboardHelp ? 'Hide' : 'Show' }} Shortcuts
              </span>
              <span class="shortcut-count" *ngIf="!showKeyboardHelp"
                >(5 shortcuts)</span
              >
            </button>
    ...
    switch (event.key) {
      ...
      case 'Enter':
        if (
          ...
          (event.target as HTMLElement).classList.contains('timer-container')
        ) {
